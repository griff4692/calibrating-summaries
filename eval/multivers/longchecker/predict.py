...
from eval.multivers.longchecker.data import get_dataloader
from eval.multivers.longchecker.util import *


def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--checkpoint_path", type=str, default='/home/t-gadams/multivers/script/checkpoints/scifact.ckpt')
...
def get_predictions(args):
    ...
    model = LongCheckerModel.load_from_checkpoint(checkpoint_path=args.checkpoint_path, strict=False)
